    ...
    public static class Selector_SelectInsideDragbox
    {
        ...
        static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
        {
            ...
            for (var i = 0; i < instructionsList.Count; i++)
            {
                ...
                if ((MethodInfo)instruction.operand == typeof(Pawn).GetMethod("get_RaceProps"))
                {
                ...
                else if((MethodInfo)instruction.operand == AccessTools.Method(typeof(RaceProperties), "get_Humanlike"))
                {
